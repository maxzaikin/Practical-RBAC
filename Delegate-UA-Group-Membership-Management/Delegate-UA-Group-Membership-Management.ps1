Function Delegate-UA-Group-Membership-Management {
    <#
        .SYNOPSIS
            Delegates "Write Members" permissions to an Active Directory group.
        ...
        .EXAMPLE
            Delegate-UA-Group-Membership-Management -role_name 'Helpdesk_Tier1' -ou 'OU=Standard Users,DC=contoso,DC=com' 
    ...
    BEGIN { 
        ...
        $MemberProperty = [GUID]"bf967a9c-0de6-11d0-a285-00aa003049e2"
    ...
    PROCESS {
        ...
        {  
            ...
            if ($WhatIf) {
                ...
                # Create a new access rule granting the role permission to write members.
